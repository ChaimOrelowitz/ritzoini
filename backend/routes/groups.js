...
const GROUP_LIST_SELECT = `
  ...
  total_sessions, default_duration, created_at, ai_notes, billing_name, zoho_session_id,
...
router.patch('/:id', requireAuth, async (req, res) => {
  try {
    ...
    const adminOnly = ['internal_name', 'supervisor_id', 'instructor_id', 'billing_name', 'zoho_session_id'];
